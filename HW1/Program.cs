namespace HW1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Задание 8
            // Пользователь вводит число.Программа должна определить, является ли это число числом Армстронга
            // (число Армстронга — это такое число, которое равно сумме своих цифр, возведённых в степень, равную количеству этих цифр).
            // Например, число 153 является числом Армстронга, так как 1 ^ 3 + 5 ^ 3 + 3 ^ 3 = 153.
